...
<html>
    <head>
        <title>Materials Settings</title>
    </head>
    <body>
        <h1 style='text-align:center;'>Materials Settings</h1>
        <br />
        ...
        <br />
        <p>Regions:</p>
        <?php if( isset ( $_SESSION['MaterialsData'] ) ) { echo $_SESSION['MaterialsData']; } ?>
        <br />
        <p><strong>Update:</strong></p>
        <form action="Materials_hdlr.php" method="POST">
            Material Type: <input name="Material_type" type="text" required/>
            <br />
